...
data RateLimitRequest = RateLimitRequest{rateLimitRequestDomain ::
                                         ...
                                         Hs.Vector Ratelimit.Proto.RateLimitDescriptor,
          ...
          = (Hs.mconcat
               [(HsProtobuf.encodeMessageField (HsProtobuf.FieldNumber 1)
                ...
                (HsProtobuf.encodeMessageField (HsProtobuf.FieldNumber 2)
                   (Hs.coerce @(Hs.Vector Ratelimit.Proto.RateLimitDescriptor)
                      @(HsProtobuf.NestedVec Ratelimit.Proto.RateLimitDescriptor)
                      rateLimitRequestDescriptors)),
...
instance HsProtobuf.Message RateLimitDescriptor where
        encodeMessage _
          ...
          = (Hs.mconcat
               [(HsProtobuf.encodeMessageField (HsProtobuf.FieldNumber 1)
                   (Hs.coerce @(Hs.Vector Ratelimit.Proto.RateLimitDescriptor_Entry)
                      @(HsProtobuf.NestedVec Ratelimit.Proto.RateLimitDescriptor_Entry)
                      rateLimitDescriptorEntries))])
        decodeMessage _
          = (Hs.pure RateLimitDescriptor) <*>
              (Hs.coerce
                 @(_ (HsProtobuf.NestedVec Ratelimit.Proto.RateLimitDescriptor_Entry))
                 @(_ (Hs.Vector Ratelimit.Proto.RateLimitDescriptor_Entry))
                 (HsProtobuf.at HsProtobuf.decodeMessageField
                    (HsProtobuf.FieldNumber 1)))
        dotProto _
          = [(HsProtobuf.DotProtoField (HsProtobuf.FieldNumber 1)
